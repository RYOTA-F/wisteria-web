export const SKILL = {
  ...
  DESCRIPTION: [
    [
      'フロントエンド/バックエンド/インフラとフルスタックな開発経験がございます。',
      '得意な言語はTypeScriptで型安全なアプリケーションを開発することが強みです。',
      'React/Vueはもちろん、Express/NestJS等のバックエンドTS開発も得意でございます。',
    ],
    [
      '制作領域ではWordPressやShopifyでのご対応も可能でございます。',
      '元営業という立場からビジネスサイドとの円滑なコミュニケーションも得意です。',
    ],
  ],
} as const
...
const SKILL_ITEMS = [
  ...
  },
  {
    TEXT: 'DynamoDB',
    ICON: 'dynamodb',
    URL: 'https://aws.amazon.com/jp/pm/dynamodb/',
  },
  {
    TEXT: 'API Gateway',
    ICON: 'api_gateway',
    URL: 'https://aws.amazon.com/jp/api-gateway/',
  },
  {
    TEXT: 'CloudFront',
    ICON: 'cloudfront',
  ...
  },
  {
    TEXT: 'EventBridge',
    ICON: 'eventbridge',
    URL: 'https://aws.amazon.com/jp/eventbridge/',
  },
  {
    TEXT: 'Swagger',
    ICON: 'swagger',
